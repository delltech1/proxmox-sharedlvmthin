...
| Progress-driven long operations | PASS at current physical envelope | Persistent schema-v3 state, monotonic QMP progress, transaction manifest, no arbitrary copy deadline, exact resume planner | Physical long-copy duration above 48 GiB remains unmeasured |
