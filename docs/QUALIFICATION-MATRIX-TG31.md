...
| 100-GiB virtual geometry motion | PASS for sparse payload | Thick live migration exposed and fixed a source-cleanup udev race; the clean retry removed the source mapper, stopped Thick-to-Thin copied 100 GiB, and the exact 8-GiB sampled digest matched before/after | This is not a fully written 100-GiB qualification |
