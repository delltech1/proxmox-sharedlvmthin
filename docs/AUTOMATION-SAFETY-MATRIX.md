...
| Thick allocation | Signed intent/object creation, full zeroing, flush and exact publication | Preserve `OPEN ALLOC` plus objects on interruption | Explicit exact partial-allocation recovery |
